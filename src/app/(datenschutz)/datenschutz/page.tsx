  ...
  return (
    <main className="max-w-lg md:max-w-7xl m-auto py-28">
      ...
      <p>
        ...
        Usercentrics GmbH, Sendlinger Stra&szlig;e 7, 80331 M&uuml;nchen,
        Website:{" "}
        <a
      ...
      <p>
        ...
        an Usercentrics &uuml;bertragen:
      </p>{" "}
      <ul>
        {" "}
        <li>
        ...
        <li>Ihre IP-Adresse</li> <li>Informationen &uuml;ber Ihren Browser</li>{" "}
      ...
      <p>
        ...
        k&ouml;nnen. Die so erfassten Daten werden gespeichert, bis Sie uns zur
        L&ouml;schung auffordern, das Usercentrics-Cookie selbst l&ouml;schen
        oder der Zweck f&uuml;r die Datenspeicherung entf&auml;llt. Zwingende
        gesetzliche Aufbewahrungspflichten bleiben unber&uuml;hrt.
      </p>{" "}
      <p>
        ...
        auch die IP-Adresse &uuml;bertragen, die jedoch nur in anonymisierter
        Form in den Server-Logs gespeichert wird. Der Bildserver von eRecht24
        befindet sich in Deutschland bei einem deutschen Anbieter. Das Banner
        selbst wird ausschlie&szlig;lich von Usercentrics zur Verf&uuml;gung
        gestellt.
      </p>
      <p>
      ...
      <p>
        ...
        ist die WhatsApp Ireland Limited, 4 Grand Canal Square, Grand Canal
        Harbour, Dublin 2, Irland.
      </p>{" "}
      <p>
        Die Kommunikation erfolgt &uuml;ber eine
        Ende-zu-Ende-Verschl&uuml;sselung (Peer-to-Peer), die verhindert, dass
        WhatsApp oder sonstige Dritte Zugriff auf die Kommunikationsinhalte
        erlangen k&ouml;nnen. WhatsApp erh&auml;lt jedoch Zugriff auf Metadaten,
        die im Zuge des Kommunikationsvorgangs entstehen (z.&nbsp;B. Absender,
        Empf&auml;nger und Zeitpunkt). Wir weisen ferner darauf hin, dass
        WhatsApp nach eigener Aussage, personenbezogene Daten seiner Nutzer mit
        seiner in den USA ans&auml;ssigen Konzernmutter Meta teilt. Weitere
        Details zur Datenverarbeitung finden Sie in der Datenschutzrichtlinie
        von WhatsApp unter:{" "}
        <a
      ...
      <p>
        ...
        Interesses an einer m&ouml;glichst schnellen und effektiven
        Kommunikation mit Kunden, Interessenten und sonstigen Gesch&auml;fts-
        und Vertragspartnern (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine
        entsprechende Einwilligung abgefragt wurde, erfolgt die
        Datenverarbeitung ausschlie&szlig;lich auf Grundlage der Einwilligung;
        diese ist jederzeit mit Wirkung f&uuml;r die Zukunft widerrufbar.
      </p>{" "}
      <p>
        Die zwischen Ihnen und uns auf WhatsApp ausgetauschten
        Kommunikationsinhalte verbleiben bei uns, bis Sie uns zur L&ouml;schung
      ...
      <p>
        Wir nutzen WhatsApp in der Variante &bdquo;WhatsApp Business&ldquo;.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Ireland Limited (&bdquo;Google&rdquo;), Gordon House, Barrow Street,
        Dublin 4, Irland.
      </p>{" "}
      <p>
        Um sich mit Google zu registrieren, m&uuml;ssen Sie ausschlie&szlig;lich
        Ihre Google-Namen und Ihr Passwort eingeben. Google wird Sie
        identifizieren und unserer Website Ihre Identit&auml;t best&auml;tigen.
      </p>{" "}
      <p>
        Wenn Sie sich mit Google anmelden, ist es uns ggf. m&ouml;glich
        bestimmte Informationen auf Ihrem Konto zu nutzen, um Ihr Profil bei uns
        zu vervollst&auml;ndigen. Ob und welche Informationen das sind,
        entscheiden Sie im Rahmen Ihrer Google-Sicherheitseinstellungen, die Sie
        hier finden:{" "}
        <a
      ...
      <p>
        ...
        m&ouml;glichst einfachen Registrierungsprozess zu erm&ouml;glichen (Art.
        6 Abs. 1 lit. f DSGVO). Da die Nutzung der Registrierungsfunktion
        freiwillig ist und die Nutzer selbst &uuml;ber die jeweiligen
        Zugriffsm&ouml;glichkeiten entscheiden k&ouml;nnen, sind keine
        entgegenstehenden &uuml;berwiegenden Rechte der Betroffenen ersichtlich.
      </p>
      <p>
        Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem
        &bdquo;EU-US Data Privacy Framework&ldquo; (DPF). Der DPF ist ein
      ...
      <p>
        ...
        enth&auml;lt, wird eine Verbindung zu Servern von LinkedIn aufgebaut.
        LinkedIn wird dar&uuml;ber informiert, dass Sie diese Website mit Ihrer
        IP-Adresse besucht haben. Wenn Sie den &bdquo;Recommend-Button&ldquo;
        von LinkedIn anklicken und in Ihrem Account bei LinkedIn eingeloggt
        sind, ist es LinkedIn m&ouml;glich, Ihren Besuch auf dieser Website
        Ihnen und Ihrem Benutzerkonto zuzuordnen. Wir weisen darauf hin, dass
        wir als Anbieter der Seiten keine Kenntnis vom Inhalt der
        &uuml;bermittelten Daten sowie deren Nutzung durch LinkedIn haben.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        k&ouml;nnen. Der Google Tag Manager selbst erstellt keine Nutzerprofile,
        speichert keine Cookies und nimmt keine eigenst&auml;ndigen Analysen
        vor. Er dient lediglich der Verwaltung und Ausspielung der &uuml;ber ihn
        ...
        Vereinigten Staaten &uuml;bertragen werden kann.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        &ndash; eine Verbindung zum Google Marketing Netzwerk her.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        eingestellt, dass Vimeo Ihre Nutzeraktivit&auml;ten nicht nachverfolgen
        und keine Cookies setzen wird.
      </p>{" "}
      <p>
