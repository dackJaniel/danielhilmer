...
export default function Home() {
  return (
    <>
      <Head>
        <title>Daniel Hilmer - Webentwicklung</title>
        <meta
          name="description"
          content="Freiberuflicher Webentwickler spezialisiert auf JavaScript-Frameworks wie React, NodeJS und NextJS."
        />
        <meta
          name="keywords"
          content="Webentwicklung, JavaScript, React, NodeJS, NextJS, Prisma, SQL, NoSQL, HTML5, CSS3, SCSS, Tailwind"
        />
      </Head>
