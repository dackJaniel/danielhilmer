    ...
    <main className="py-10 flex flex-col gap-8 md:max-w-5xl m-auto px-2 max-w-4xl">
      ...
      <section className="flex gap-2">
        <Image
          ...
          alt="Person Designed und Programmiert eine Individuelle Webseite"
          ...
          <CardContent>
            ...
            <ul>
              ...
              <CheckIconItem>
                ...
                jederzeit möglich, um Ihren wachsenden Anforderungen gerecht zu
                werden.
              </CheckIconItem>
              <CheckIconItem>
              ...
              <CheckIconItem>
                <strong>SEO-Optimierung:</strong> Durch gezielte Maßnahmen wird
                Ihre Website besser von Suchmaschinen gefunden, was mehr
        ...
        <Card className="md:w-2/3 w-full ">
          ...
          <CardContent>
            ...
            <ul className="list-disc list-inside">
              ...
              <CheckIconItem>
                <strong>Kosten für Website Erstellung:</strong> Transparente und
                faire Preise für jedes Budget.
              </CheckIconItem>
              <CheckIconItem>
                <strong>Webseiten Relaunch:</strong> Ich bringe Ihre bestehende
                Internetseite auf den neuesten Stand.
              </CheckIconItem>
              <CheckIconItem>
                <strong>Website mit eigener Domain:</strong> Ideal für Start-ups
      ...
      <section className="flex flex-col gap-8">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold">
          Transparente Preise – Was kostet es, eine Website erstellen zu lassen?
        </h2>
            ...
            <div>
              ...
              <CardContent>
                <ul className="list-disc list-inside grid md:grid-cols-2">
                  ...
                  <CheckIconItem>
                    Auf basis modernster Technologien wie JavaScript, React und
                    NextJS
                  </CheckIconItem>
                </ul>
              </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p>
              ...
              kostenlose Beratung und erfahren Sie mehr über die Kosten für die
              Erstellung einer Website.
            </p>
            <strong>
              Ihr Erfolg ist nur einen Klick entfernt – Lassen Sie Ihre Website
              von einem Profi erstellen!
            </strong>
          </CardContent>
          <CardFooter>
            <Button asChild variant="default">
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              Projekts. In der Regel kann eine einfache Internetseite innerhalb
              von 2-4 Wochen fertiggestellt werden. Ein genauer Zeitrahmen wird
              während der Planungsphase festgelegt.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger>
              Kann ich meine Website nach der Fertigstellung selbst bearbeiten?
            </AccordionTrigger>
            <AccordionContent>
              Je nach Wunsch kann Ihre Webseite mit einem Content Management
              System (CMS) ausgestattet werden, das es Ihnen ermöglicht, Inhalte
              selbst zu pflegen und zu aktualisieren. Ich berate Sie gerne zu
              den verschiedenen Möglichkeiten.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-4">
            <AccordionTrigger>
              Bieten Sie auch einen Webseiten Relaunch für bestehende Seiten an?
            </AccordionTrigger>
            <AccordionContent>
              Absolut! Ich unterstütze Sie gerne dabei, Ihre vorhandene Homepage
              zu modernisieren und technisch auf den neuesten Stand zu bringen.
              Ein Webseiten Relaunch kann das Design auffrischen und die
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              Als Freelancer biete ich Ihnen persönliche Betreuung, Flexibilität
              und direkte Kommunikation. Sie profitieren von maßgeschneiderten
              Lösungen und haben einen festen Ansprechpartner für alle Fragen
              rund um die Erstellung Ihrer Website.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
