...
function WordPressPage() {
  return (
    <>
      <Head>
        <title>Ihre WordPress-Website</title>
        <meta
          name="description"
      ...
      <main className="py-10 flex flex-col gap-8 md:max-w-5xl m-auto px-2 max-w-4xl">
        ...
        <p>
          Sie möchten eine professionelle WordPress Homepage erstellen lassen,
          die sich von der Masse abhebt und auf Ihre individuellen Bedürfnisse
          ...
          <Card className="md:w-2/3 w-full ">
            ...
            <CardContent>
              <p>
                ...
                und bietet unendliche Möglichkeiten für Ihre Website. Egal, ob
                Sie eine Unternehmensseite, einen Blog, oder einen Onlineshop
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside">
                <CheckIconItem>
                  ...
                  mittelständische Unternehmen, die eine professionelle
                  Webpräsenz benötigen.
                </CheckIconItem>
                <CheckIconItem>
        ...
        <section className="flex flex-col gap-8">
          ...
          <p>
            Eine WordPress Website erstellen zu lassen, muss nicht teuer sein.
            Bei mir erhalten Sie eine transparente Kostenstruktur ohne
            versteckte Gebühren. Sie entscheiden, welches Leistungspaket am
            besten zu Ihrem Budget und Ihren Zielen passt.
          </p>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Sie haben Fragen oder möchten eine individuelle WordPress
                Website erstellen lassen? Kontaktieren Sie mich gerne für ein
        ...
        <section className="my-5">
          ...
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>
                Was ist der Unterschied zwischen WordPress.org und
                WordPress.com?
              </AccordionTrigger>
              <AccordionContent>
                WordPress.org bietet Ihnen volle Kontrolle über Ihre Website,
                während WordPress.com gehostete Lösungen anbietet. Beide
                Varianten haben ihre Vorteile, je nachdem, wie viel Kontrolle
                und Flexibilität Sie wünschen.
              </AccordionContent>
            </AccordionItem>
